...
public class YZRender implements MazeRender {
    private game.Maze maze;
    private game.Player player;
    private int cellSize;

    public YZRender(game.Maze maze, game.Player player) {
        this.maze = maze;
        this.player = player;
